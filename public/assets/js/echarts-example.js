...
var echartsBarLineChartInit2 = function echartsBarLineChartInit2() {
  var $barLineChartEl = document.querySelector('.echart-bar-line-chart-example_test');
  if ($barLineChartEl) {
    // Get options from data attribute
    var userOptions = utils.getData($barLineChartEl, 'options');
    var chart = window.echarts.init($barLineChartEl);
  ...
  title: {
	    ...
	    text: '아시아 수입 가격(CFR)=대형모선 HMS No.1(8:2)    386.00/10(2.7%)-차트'
  },
  ...
  legend: {
    data: '아시아 수입 가격(CFR)=대형모선 HMS No.1(8:2)'
  },
  xAxis: [
    {
	   crosshair: true,
  ...
  yAxis: [
    ...
    {
      type: 'value',
      name: '아시아 수입 가격(CFR)=대형모선 HMS No.1(8:2)',
