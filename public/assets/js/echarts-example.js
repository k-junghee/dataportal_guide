...
const echartsBarRaceChartInit = () => {
  ...
  if ($barRaceChartEl) {
    ...
    echartSetOption(chart, userOptions, getDefaultOptions);
    const run = () => {
      data = data.map(item => Math.random() > 0.9 ? item + Math.round(Math.random() * 2000) : item + Math.round(Math.random() * 200));
      chart.setOption({
        series: [{
          data
        }]
...
const echartsWaterFallChartInit = () => {
  ...
  if ($waterfallChartEl) {
    ...
    const days = ['2021-06-05', '2021-06-06', '2021-06-07', '2021-06-08', '2021-06-09', '2021-06-10', '2021-06-11', '2021-06-12', '2021-06-13', '2021-06-14', '2021-06-15'];
    const getDefaultOptions = () => ({
      legend: {
...
const echartsCandlestickMixedChartInit = () => {
  const $candleStickMixedChartEl = document.querySelector('.echart-candlestick-mixed-chart-example');
...
const echartsRadarCustomizedChartInit = () => {
  ...
  function getFormatter(params) {
    const indicators = [['Marketing', 'Sales', 'Dev', 'Support', 'Tech', 'Admin'], ['Language', 'Math', 'English', 'Physics', 'Chemistry', 'Biology']];
...
const echartsScatterSingleAxisChartInit = () => {
  const $scatterSingleAxisChartEl = document.querySelector('.echart-scatter-single-axis-chart-example');
...
const echartsHorizontalStackedChartInit = () => {
  const $horizontalStackChartEl = document.querySelector('.echart-horizontal-stacked-chart-example');
